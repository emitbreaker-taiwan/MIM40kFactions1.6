...
{
    public class CompProperties_PawnSanitizerConsumables : CompProperties, ISanitizerSource
    {
        [NoTranslate]
        ...
        public CompProperties_PawnSanitizerConsumables()
        {
            this.compClass = typeof(CompUseEffect_PawnSanitizerConsumables);
        }

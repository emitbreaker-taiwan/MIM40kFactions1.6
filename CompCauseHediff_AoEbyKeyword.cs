...
namespace MIM40kFactions
{
    public class CompCauseHediff_AoEbyKeyword : ThingComp
    {
        ...
        {
            // Faction Validation
            if (!Utility_PawnValidator.FactionValidator(target, parent, Props.onlyTargetNotinSameFactions, Props.onlyTargetHostileFactions, Props.onlyPawnsInSameFaction, Props.onlyTargetNonPlayerFactions))
            {
                return false;
            }

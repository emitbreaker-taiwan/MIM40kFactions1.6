...
{
    public class CompAbilityEffect_TeleportbyKeyword : CompAbilityEffect_WithDest
    {
        public static string SkipUsedSignalTag = "CompAbilityEffect.SkipUsed";

        public new CompProperties_AbilityTeleportbyKeyword Props => (CompProperties_AbilityTeleportbyKeyword)props;
        ...
        public override void Apply(LocalTargetInfo target, LocalTargetInfo dest)
        {
            ...
            if (target.Thing is Pawn pawn2 && FactionValidator(pawn2))
            {

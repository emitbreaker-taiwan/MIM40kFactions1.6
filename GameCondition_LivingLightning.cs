...
{
    public class GameCondition_LivingLightning : GameCondition
    {
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look<Pawn>(ref caster, "caster", defaultValue: null);
        }
        ...
        {
            if (loc.GetFirstPawn(base.SingleMap) == null)
            {
                return false;
            }
            ...
            if (caster != null && loc.GetFirstPawn(base.SingleMap).Faction == caster.Faction) 
            {
                return false;
            }               

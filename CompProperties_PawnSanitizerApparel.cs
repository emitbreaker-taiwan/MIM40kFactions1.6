...
{
    public class CompProperties_PawnSanitizerApparel : CompProperties, ISanitizerSource
    {
        [NoTranslate]
        ...
        public CompProperties_PawnSanitizerApparel()
        {
            this.compClass = typeof(CompPawnSanitizerApparel);
        }

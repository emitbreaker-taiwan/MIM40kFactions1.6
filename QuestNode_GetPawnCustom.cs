...
{
    public class QuestNode_GetPawnCustom : QuestNode
    {
        [NoTranslate]
        ...
        public SlateRef<List<FactionDef>> allowedFactionDefs;
        ...
        private bool TryFindFactionForPawnGeneration(Slate slate, out Faction faction)
        {
            ...
            {
                if (allowedFactionDefs.GetValue(slate) != null && !allowedFactionDefs.GetValue(slate).Contains(x.def))
                {
                    return false;
                }

...
{
    public class CompProperties_PawnSanitizer : CompProperties, ISanitizerSource
    {
        [NoTranslate]
        ...
        public bool onlyForHumanlike = false; // ✅ NEW

        public CompProperties_PawnSanitizer()
        {
            this.compClass = typeof(CompPawnSanitizer);
        }

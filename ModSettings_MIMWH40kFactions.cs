...
namespace MIM40kFactions
{
    public class ModSettings_MIMWH40kFactions : ModSettings
    {
        ...
        public bool enableHarmonyThoughtBlocking = true;
        public bool enableHarmonyThoughtFiltering = true;
        [NoTranslate]
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(ref enableHarmonyThoughtBlocking, "enableHarmonyThoughtBlocking", true);
            Scribe_Values.Look(ref enableHarmonyThoughtFiltering, "enableHarmonyThoughtFiltering", true);
